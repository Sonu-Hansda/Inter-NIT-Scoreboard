...
export default function ScoreTable() {
  ...
  const [tableTennisGender, setTableTennisGender] = useState<'boys' | 'girls'>('boys');
  ...
  const getCurrentSportVideos = (): VideoSource[] => {
    switch (selected) {
      ...
      case 'Table Tennis':
        return tableTennisGender === 'boys' ? VIDEO_CONFIG.tableTennisBoys : VIDEO_CONFIG.tableTennisGirls;
      case 'Futsal':
  ...
  const renderScoreboard = () => {
    switch (selected) {
      ...
      case 'Table Tennis':
        return <TableTennisScoreboard viewGender={tableTennisGender} setViewGender={handleTableTennisGenderChange} />;
      case 'Futsal':
  ...
  return (
    <div className="min-h-screen bg-gray-100 text-gray-800 p-6 md:p-10">
      <div className="max-w-6xl mx-auto animate-fade-in">
        ...
        <div className="flex flex-wrap justify-center items-center gap-8 mt-12 py-4 border-t border-gray-300">
          <img src="/internit_logo.png" loading='lazy' alt="Organizing Committee Logo 2" className="h-20 w-20 object-contain" />
          <img src="/nitjsr_logo.png" loading='lazy' alt="Organizing Committee Logo 1" className="h-20 w-20 object-contain" />
          <img src="/fit_india.png" loading='lazy' alt="Organizing Committee Logo 3" className="h-20 w-20 object-contain" />
        </div>
      </div>
    </div>
  );
